...
export function notice(config, type = 'default') {
  Object.trigger(SHOW_NOTICE, { type, config });
  return hide;
}

export function hide() {
  Object.trigger(HIDE_NOTICE);
}
...
class Normal extends PureComponent {
  constructor() {
    super();
    // Object.on(SHOW_NOTICE, this.showNotice);
    // Object.on(HIDE_NOTICE, this.hideNotice);
  ...
  componentWillUnmount() {
    // Object.off(SHOW_NOTICE, this.showNotice); // 清理监听
    // Object.off(HIDE_NOTICE, this.hideNotice);
  }
